            ...
            <table class="w-full text-sm">
                <thead>
                    <tr class="border-b border-zinc-200 bg-zinc-50">
                        ...
                        <th class="hidden sm:table-cell px-4 py-3 text-left font-medium text-zinc-500 uppercase tracking-wider text-xs">Email Verified</th>
                        <th class="hidden sm:table-cell px-4 py-3 text-left font-medium text-zinc-500 uppercase tracking-wider text-xs">Joined</th>
                ...
                <tbody class="divide-y divide-zinc-100">
                    @foreach($users as $user)
                        <tr class="hover:bg-zinc-50 transition-colors">
                            ...
                            <td class="hidden sm:table-cell px-4 py-3 text-zinc-500">
                            ...
                            <td class="hidden sm:table-cell px-4 py-3 text-zinc-400">{{ $user->created_at->format('Y-m-d') }}</td>
