...
<div class="bg-white rounded-xl border border-zinc-200 shadow-sm max-w-lg">
    <div class="px-6 py-5 border-b border-zinc-100">
        ...
        <p class="text-sm text-zinc-500 mt-0.5">Define a label for classifying entries (e.g. snippet, question, document).</p>
    </div>

    <div class="px-6 py-5">
        <form method="POST" action="{{ route('entry-types.store') }}" class="space-y-4">
            @csrf
